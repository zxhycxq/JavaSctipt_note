...
An arrow function expression (also known as fat arrow function) has a shorter syntax compared to function expressions and lexically binds the this value. 箭头函数 are always anonymous.
...
try {
  ...
  console.log('我最喜爱的数字仍是: ' + favorite);
  // will still print 7
}
```
